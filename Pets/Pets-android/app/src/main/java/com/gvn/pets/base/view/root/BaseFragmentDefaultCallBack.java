...
public abstract class BaseFragmentDefaultCallBack<T extends BasePresenter> extends BaseFragment<T> implements RetrofitCallback.DefaultViewCallBack {
    ...
    public void showError(int code) {
        switch (code) {
            ...
            case ServerResponse.SERVER_INVALID_TOKEN:
                presenter.onAutoLogin(getActivity().getApplicationContext());
                break;
